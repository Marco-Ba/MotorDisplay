# 1 "../partidaEstrelaTriangulo.X/contatores.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../partidaEstrelaTriangulo.X/contatores.c" 2
...
# 9 "../partidaEstrelaTriangulo.X/contatores.c" 2
...
# 10 "../partidaEstrelaTriangulo.X/contatores.c" 2
